...
void test_validate_my_username()
{
     ...
     */
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(), malloc_username_from_conf_file(), "Your username from my_username() does not match the username in conf/username.txt, please fix!");
}
